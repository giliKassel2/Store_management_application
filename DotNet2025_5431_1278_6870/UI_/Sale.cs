...
namespace UI
{
    public partial class Sale : Form
    {
        ...
        private void updateLists(List<BO.Sale> salesL)
        {
            ...
            {
                salesDgv.Rows.Add(sale.SaleCode, s_bl.Product.Read(sale.ProductId).ProductName, sale.ProductId, sale.QuantityForSale, sale.SalePrice, sale.StartSale, sale.EndSale);
            }

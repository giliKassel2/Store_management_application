namespace UI
{
    partial class Sale
    {
        ...
        private void InitializeComponent()
        {
            ...
            salesDgv.Columns.AddRange(new DataGridViewColumn[] { producerCode, מוצר, productId, amountSale, priceSale, StartSale, EndSale });
            salesDgv.GridColor = SystemColors.Control;
            salesDgv.Location = new Point(553, 187);
            salesDgv.Margin = new Padding(3, 4, 3, 4);
            salesDgv.Name = "salesDgv";
            salesDgv.RightToLeft = RightToLeft.Yes;
            salesDgv.RowHeadersWidth = 51;
            salesDgv.Size = new Size(711, 587);
            ...
            label13.Font = new Font("Segoe UI Semibold", 16.2F, FontStyle.Bold, GraphicsUnit.Point);
